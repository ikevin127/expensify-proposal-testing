...
var OpenAIUtils = /** @class */ (function () {
    ...
    OpenAIUtils.init = function (apiKey, assistantID) {
        var key = apiKey !== null && apiKey !== void 0 ? apiKey : (0, core_1.getInput)('OPENAI_API_KEY', { required: true });
        if (!key) {
            throw new Error('Could not initialize OpenAI: No key provided.');
        }
        this.ai = new openai_1.default({ apiKey: key });
        this.assistantID = assistantID !== null && assistantID !== void 0 ? assistantID : (0, core_1.getInput)('OPENAI_ASSISTANT_ID', { required: true });
    };
                ...
                switch (_g.label) {
                    ...
                    case 7:
                        ...
                        response += message.content
                            .map(function (contentBlock) { return _this.isTextContentBlock(contentBlock); })
                            .join('\n')
                            .trim();
